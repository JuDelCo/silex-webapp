...
$(document).ready(function()
{
	...
	(function(bootstro, $, undefined)
	{
		...
		var defaults = {
			...
			//onStepStart : function(params){} //params = {idx : activeIndex, direction : [next|prev]}
			//onStepEnd : function(params){} //params = {idx : activeIndex, direction : [next|prev]}
		...
		get_popup = function(i)
		{
			...
			p.template = '<div class="popover bootstro" style="' + style + '"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-title"></h3><div class="popover-content"><p></p></div></div>' +
			 '</div>';
		...
		bootstro.next = function()
		{
			...
			{
				if (typeof settings.onStepStart == 'function')
					settings.onStepStart.call(this, {idx : activeIndex + 1, direction : 'next'});

				bootstro.go_to(activeIndex + 1);

				if (typeof settings.onStepEnd == 'function')
					settings.onStepEnd.call(this, {idx : activeIndex, direction : 'next'});
			}
		};
		...
		bootstro.prev = function()
		{
			...
			{
				if (typeof settings.onStepStart == 'function')
					settings.onStepStart.call(this, {idx : activeIndex - 1, direction : 'prev'});

				bootstro.go_to(activeIndex - 1);

				if (typeof settings.onStepEnd == 'function')
					settings.onStepEnd.call(this, {idx : activeIndex, direction : 'prev'});
			}
		};
		...
		bootstro._start = function(selector)
		{
			...
			if (count > 0 && $('div.bootstro-backdrop').length === 0)
			{
				...
				if(typeof settings.backdropContainer != 'undefined')
				{
					$('<div class="bootstro-backdrop"></div>').appendTo(settings.backdropContainer);
				}
				else
				{
